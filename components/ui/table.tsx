...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm bg-[#1C1C1C]", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-none bg-[#1C1C1C] font-medium [&>tr]:last:border-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-none transition-colors hover:bg-gray-900/50 data-[state=selected]:bg-gray-900",
      className
    )}
    {...props}
  />
